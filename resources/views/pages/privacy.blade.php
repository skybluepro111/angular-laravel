...
<div class="landing">
	...
	<section class="content">
        ...
        <p>
            This Privacy Policy governs the manner in which {{ config('custom.app-name') }} collects,
            uses, maintains and discloses information collected from users (each, a "User") of the
            http://{{ config('custom.app-domain') }} website ("Site"). This privacy policy applies to
            the Site and all products and services offered by {{ config('custom.app-name') }}.
        </p>
        ...
        <p>
            ...
            not limited to, when Users visit our site, register on the site, and in connection with other
            ...
            personal identification information from Users only if they voluntarily submit such information to
        ...
        <p>
            At {{ config('custom.app-domain') }}, the privacy of our visitors is of extreme importance
            to us. This privacy policy document outlines the types of personal information is received and
            collected by {{ config('custom.app-domain') }} and how it is used.
            <br/><br/>
            Log Files
            Like many other Web sites, {{ config('custom.app-domain') }} makes use of log files. The
            ...
            {{ config('custom.app-domain') }} does use cookies to store information about visitors
            ...
            on {{ config('custom.app-domain') }}.
            .:: Google's use of the DART cookie enables it to serve ads to users based on their visit
            to {{ config('custom.app-domain') }} and other sites on the Internet.
            ...
            appear on {{ config('custom.app-domain') }} send directly to your browsers. They
            ...
            {{ config('custom.app-domain') }} has no access to or control over these cookies that are
            used by third-party advertisers.

            You should consult the respective privacy policies of these third-party ad servers for more detailed
            information on their practices as well as for instructions about how to opt-out of certain
            practices. {{ config('custom.app-domain') }}'s privacy policy does not apply to, and we
            cannot control the activities of, such other advertisers or web sites
        </p>
        <h4>How we use collected information</h4>

        <p>
            {{ config('custom.app-name') }} may collect and use Users personal information for the
            following purposes:
        ...
        <p>
            ...
            http://{{ config('custom.app-domain') }}
            admin [at] {{ config('custom.app-domain') }}
        </p>
